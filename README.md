...
Ожидаемый SHA256 официального архива `zapret-discord-youtube-1.10.2.zip`:

```text
5EAAC9FB2E4B1ABD693487452A3FF3F4DFE9578A45F9DDDDFA4BC1F5A6BB62D5
```

В самом BAT значение разбито техническим пробелом для читаемости, а перед сравнением пробел автоматически удаляется.
